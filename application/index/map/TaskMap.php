...
class TaskMap extends BaseModel {
    ...
    public static function instance($id = 0) {
        if($id >= 0) {
            ...
            return count((array)static::$instances_array);
        }else if($id == -2) {
            return static::instance(count((array)static::$instances_array));
        }else{
            return null;
        }
    }
