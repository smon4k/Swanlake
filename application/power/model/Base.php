...
class Base extends Model
{
    ...
    public function __construct($data=[])
    {
        ...
        if (!getIsCli()) {
            $envStatus = getEnvs();
            if ($envStatus === 'dev') {
                if (file_exists(APP_PATH."power/database_hp_dev.php")) {
                    $this->connection = include APP_PATH."power/database_hp_dev.php";
                }
            } else {
                if (file_exists(APP_PATH."power/database_hp_prod.php")) {
                    $this->connection = include APP_PATH."power/database_hp_prod.php";
                }
            }
        } else {
            if (file_exists(APP_PATH."power/database_hp_prod.php")) {
