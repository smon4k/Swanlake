...
class Base extends Model
{
    ...
    public function __construct($data=[])
    {
        ...
        $envStatus = getEnvs();
        if ($envStatus === 'dev') {
            if (file_exists(APP_PATH."hashpower/database_hp_dev.php")) {
                $this->connection = include APP_PATH."hashpower/database_hp_dev.php";
            }
        } else {
            if (file_exists(APP_PATH."hashpower/database_hp_prod.php")) {
                $this->connection = include APP_PATH."hashpower/database_hp_prod.php";
            }
        }
        // }
    }
