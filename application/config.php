...
return [
    ...
    'root_namespace'         => [],
    // 扩展函数文件
    'extra_file_list'        => [THINK_PATH . 'helper' . EXT, APP_PATH. 'common_for_smart' . EXT],
    // 默认输出类型
    ...
    'WECHAT_TOKEN_KEY' => "JointExamination:Wechat:access_token", //微信公众号access_token key值
