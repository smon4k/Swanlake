...
-- ----------------------------
-- Table structure for g_trade_symbols
-- ----------------------------
DROP TABLE IF EXISTS `g_trade_symbols`;
CREATE TABLE `g_trade_symbols` (
  `id` int NOT NULL AUTO_INCREMENT,
  `symbol` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL COMMENT '现货/基础交易对，如 BTC-USDT',
  `swap_symbol` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL COMMENT '合约交易对，如 BTC-USDT-SWAP',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci COMMENT='Grid 支持的交易对配置表';

INSERT INTO `g_trade_symbols` (`symbol`, `swap_symbol`, `contract_value`, `status`, `sort`) VALUES
