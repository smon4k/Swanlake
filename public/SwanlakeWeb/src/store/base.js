...
export default {
    state :{
        ...
        apiUrl: window.location.host === 'localhost:8008' ? 'https://www.yutstly.xyz' : 'https://www.yutstly.xyz',
        // apiUrl: 'https://',
        nftUrl: window.location.host === 'localhost:8008' || window.location.host === '192.168.1.3:8007' ? 'http://www.api.com' : 'https://api.h2opower.site',
                    ...
                    await Promise.all(fixedList.map(async item => {
                        ...
                        if(info) {
                            if(info.is_give_income && info.is_give_income > 0) { //大于第一次购买 第二天 给收益
                                ...
                                let yest_income_h2o =  Number(info.userBalance) * 0.1; //昨日H2O收益
                                ...
                                info.yest_income_h2o = yest_income_h2o < 0 ? 0 : yest_income_h2o;
                                info.yest_income_h2ousdt = yest_income_h2ousdt < 0 ? 0 : yest_income_h2ousdt;
