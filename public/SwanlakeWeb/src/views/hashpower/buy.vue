        ...
        <el-row>
          <el-col :span="24" class="agree-item">
            ...
            <div class="agree-item-buttom">
              <el-button :disabled="!agree || trading || detailData.stock <= 0" v-if="approve" v-loading="trading"
                @click="startPurchase">{{ detailData.stock > 0 ? $t('subscribe:Purchase') : $t('subscribe:SoldOut')
                }}</el-button>
              <el-button :disabled="!agree || trading" v-loading="trading" v-else-if="!approve"
                @click="startApprove()">{{
                  $t('subscribe:Approve') }}</el-button>
            </div>
