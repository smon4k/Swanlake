<template>
  <div>
    <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item to="">USDT充提列表</el-breadcrumb-item>
    </el-breadcrumb>
    ...
    <el-table :data="tableData" style="width: 100%;" v-loading="loading">
      ...
      <el-table-column prop="local_balance" label="充值数量(USDT)" width="120" align="center">
...
export default {
  ...
  methods: {
    getListData(ServerWhere) {
      ...
      this.loading = true;
      get("/Admin/Filling/getUSDTDepositWithdrawRecord", ServerWhere, json => {
          console.log(json);
          this.loading = false;
