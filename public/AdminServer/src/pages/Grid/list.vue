                ...
                <el-table-column prop="type" label="交易方向" align="center">
                    <template slot-scope="scope">
                      <div v-if="scope.row.side">
                        <span v-if="scope.row.side ===  'buy' && scope.row.pos_side === 'long'" style="color:#05C48E">买入开多</span>
                        <span v-else-if="scope.row.side === 'buy' && scope.row.pos_side === 'short'" style="color:#05C48E">买入平空</span>
                        <span v-else-if="scope.row.side === 'sell' && scope.row.pos_side === 'long'" style="color:#df473d;">卖出平多</span>
                        <span v-else-if="scope.row.side === 'sell' && scope.row.pos_side ==='short'" style="color:#df473d;">卖出开空</span>
