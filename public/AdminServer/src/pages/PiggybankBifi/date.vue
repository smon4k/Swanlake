        ...
        <el-tab-pane label="网格数据">
            <el-table :data="tableData" style="width: 100%;">
                ...
                <el-table-column prop="amount" label="总市值" align="center">
                    ...
                    <span>{{ keepDecimalNotRounding(scope.row.count_market_value, 8, true) }} BUSD</span>
                    </template>
                </el-table-column>
                <el-table-column prop="grid_spread" label="网格日利润" align="center">
                    <template slot-scope="scope">
                    <span>{{ keepDecimalNotRounding(scope.row.grid_day_spread, 4, true) }} {{scope.row.base_ccy}} BUSD</span>
                    </template>
                </el-table-column>
                ...
                <el-table-column prop="" label="网格总利润" align="center">
                    <template slot-scope="scope">
                    <span>{{ keepDecimalNotRounding(scope.row.grid_spread, 4, true) }} BUSD</span>
                    </template>
                </el-table-column>
                    ...
                    <div v-if="UtableData.length">
                        <el-table :data="UtableData" style="width: 100%;">
                            ...
                            <el-table-column prop="principal" label="累计本金" align="center">
                                <template slot-scope="scope">
                                <span>{{ keepDecimalNotRounding(scope.row.principal, 4, true) }} BUSD</span>
                                </template>
                            </el-table-column>
                            <el-table-column prop="" label="总结余" align="center">
                                <template slot-scope="scope">
                                <span>{{ keepDecimalNotRounding(scope.row.total_balance, 4, true) }} BUSD</span>
                                </template>
                            </el-table-column>
                            <el-table-column prop="" label="币价" align="center">
                                <template slot-scope="scope">
                                <span>{{ keepDecimalNotRounding(scope.row.price, 4, true) }} BUSD</span>
                                </template>
                            </el-table-column>
                            <el-table-column prop="" label="日利润" align="center">
                                <template slot-scope="scope">
                                <span>{{ keepDecimalNotRounding(scope.row.daily_profit, 4, true) }} BUSD</span>
                                </template>
                            </el-table-column>
                            ...
                            <el-table-column prop="" label="利润" align="center">
                                <template slot-scope="scope">
                                <span>{{ keepDecimalNotRounding(scope.row.profit, 4, true) }} BUSD</span>
                                </template>
                            </el-table-column>
                ...
                <el-tab-pane label="币本位">
                    <div v-if="BtableData.length">
                        <el-table :data="BtableData" style="width: 100%;">
                            ...
                            <el-table-column prop="principal" label="累计本金" align="center">
                                <template slot-scope="scope">
                                <span>{{ keepDecimalNotRounding(scope.row.principal, 4, true) }} BIFI</span>
                                </template>
                            </el-table-column>
                            <el-table-column prop="" label="总结余" align="center">
                                <template slot-scope="scope">
                                <span>{{ keepDecimalNotRounding(scope.row.total_balance, 4, true) }} BIFI</span>
                                </template>
                            </el-table-column>
                            <el-table-column prop="" label="币价" align="center">
                                <template slot-scope="scope">
                            ...
                            <el-table-column prop="" label="日利润" align="center">
                                <template slot-scope="scope">
                                <span>{{ keepDecimalNotRounding(scope.row.daily_profit, 4, true) }} BIFI</span>
                                </template>
                            </el-table-column>
                            <el-table-column prop="" label="日利润率" align="center">
                                <template slot-scope="scope">
                            ...
                            <el-table-column prop="" label="利润" align="center">
                                <template slot-scope="scope">
                                <span>{{ keepDecimalNotRounding(scope.row.profit, 4, true) }} BIFI</span>
                                </template>
                            </el-table-column>
                            <el-table-column prop="" label="利润率" align="center">
                                <template slot-scope="scope">
...
export default {
  ...
  methods: {
    ...
    getListData(ServerWhere) { //获取网格数据
      ...
      get("/Admin/Binancepiggybank/getPiggybankOrderDateList", ServerWhere, json => {
          console.log(json);
    ...
    getUListData(ServerWhere) { //获取U本位数据
      ...
      get("/Admin/Binancepiggybank/getUBPiggybankOrderDateList", ServerWhere, json => {
          console.log(json);
        if (json.data.code == 10000) {
    ...
    submitForm(formName) {
        this.$refs[formName].validate((valid) => {
            if (valid) {
                get('/Admin/Binancepiggybank/calcDepositAndWithdrawal', {
