        ...
        <el-tab-pane label="数据">
            <el-table :data="tableData" style="width: 100%;">
                ...
                <el-table-column prop="amount" label="总市值" align="center">
                    ...
                    <span>{{ keepDecimalNotRounding(scope.row.count_market_value, 2, true) }} BUSD</span>
                    </template>
                </el-table-column>
                <el-table-column prop="grid_spread" label="网格日利润" align="center">
                    <template slot-scope="scope">
                    <span>{{ keepDecimalNotRounding(scope.row.grid_day_spread, 2, true) }} {{scope.row.base_ccy}} BUSD</span>
                    </template>
                </el-table-column>
                ...
                <el-table-column prop="" label="网格总利润" align="center">
                    <template slot-scope="scope">
                    <span>{{ keepDecimalNotRounding(scope.row.grid_spread, 2, true) }} BUSD</span>
                    </template>
                </el-table-column>
                    ...
                    <div v-if="UtableData.length">
                        <el-table :data="UtableData" style="width: 100%;">
                            ...
                            <el-table-column prop="principal" label="累计本金" align="center">
                                <template slot-scope="scope">
                                <span>{{ keepDecimalNotRounding(scope.row.principal, 2, true) }} BUSD</span>
                                </template>
                            </el-table-column>
                            <el-table-column prop="" label="总结余" align="center">
                                <template slot-scope="scope">
                                <span>{{ keepDecimalNotRounding(scope.row.total_balance, 2, true) }} BUSD</span>
                                </template>
                            </el-table-column>
                            <el-table-column prop="" label="币价" align="center">
                                <template slot-scope="scope">
                                <span>{{ keepDecimalNotRounding(scope.row.price, 2, true) }} BUSD</span>
                                </template>
                            </el-table-column>
                            <el-table-column prop="" label="日利润" align="center">
                                <template slot-scope="scope">
                                <span>{{ keepDecimalNotRounding(scope.row.daily_profit, 2, true) }} BUSD</span>
                                </template>
                            </el-table-column>
                            ...
                            <el-table-column prop="" label="利润" align="center">
                                <template slot-scope="scope">
                                <span>{{ keepDecimalNotRounding(scope.row.profit, 2, true) }} BUSD</span>
                                </template>
                            </el-table-column>
