...
class okex extends Exchange {
    ...
    public function fetch_users_subaccount_list($params = array ()) {
        ...
        $params = $this->omit($params, 'type');
        $method = null;
        $method = 'privateGetUsersSubaccountList';
        $request = array(
            // 'ccy' => 'BTC,ETH', // comma-separated list of currency ids
        );
        $response = $this->$method (array_merge($request, $params));
    ...
    public function parse_position($position, $market = null) {
        ...
        // p($unrealizedPnlString);
        $collateralString = null;
        if($initialMarginString && $unrealizedPnlString) {
        ...
        // p($percentageString);
        $percentage = $percentageString ? $this->parse_number(Precise::string_mul($percentageString, '100')) : 0;
        // echo 111;die;
        ...
        // p($entryPriceString);
        // p($this->parse_number($entryPriceString));
        return array(
            'info' => $position,
            'symbol' => $symbol,
            'notional' => $notional,
